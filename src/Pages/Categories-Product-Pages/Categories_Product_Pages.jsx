  ...
  return (
    <>
      <div className="flex">
        ...
        <div className="w-4/6">
          <div class="flex flex-wrap selectBorder">
          ...
          <div className="flex flex-wrap justify-center">
            {boxes.map((box) => (
              <div key={box} className="flex-1 min-w-[260px] p-2">
                <div className="bg-white rounded-md shadow-2xl overflow-hidden hover:shadow-3xl CTPRBOX">
                  ...
                  <div className="p-4">
                    <h2 className="text-xl font-extrabold text-gray-800 mb-2 line-clamp-2">Cosmic Headphones</h2>
                    <p className="text-gray-600 text-left mb-4 font-xs line-clamp-3">Experience music like never before with our state-of-the-art Cosmic Headphones.
